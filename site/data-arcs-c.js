...
var chartSettings = {
    ...
    */
    ...
    title: 'Calendar Arc',
    desc: 'Calendar Arc v1',
};

var generateCopyright = function(range, innerRadius, outerRadius) {
    var segments = [];
...
var generateCircles = function(range, innerRadius, outerRadius) {
    var segments = [];
...
var generateDataset = function(start, end, innerRadius, outerRadius) {
    ...
    return {
        copyright:  generateCopyright(range, 575, 600),
        ...
        circle1:    generateCircles(range, 1000, 1025),
        circle2:    generateCircles(range, 1025, 1050),
        circle3:    generateCircles(range, 1050, 1075),
        circle4:    generateCircles(range, 1075, 1100),
        circle5:    generateCircles(range, 1100, 1125),
        chainBig:     chainBig(range, 1125, 1390),
